...
exports.ordersGetAll = (req, res, next) => {//GET
...
exports.ordersPost = (req, res, next) => {//POST
...
exports.ordersGetOne = (req, res, next) => {//GET by ID
...
exports.ordersDeleteOne = (req, res, next) => {//DELETE by ID
