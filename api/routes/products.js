...
router.post('/',upload.single('productImage'),(req,res,next)=>{//POST
...
router.get('/:productId',(req,res,next)=>{//GET by ID
...
router.patch('/:productId',(req,res,next)=>{//PATCH by ID
    const id = req.params.productId
...
router.delete('/:productId',(req,res,next)=>{//DELETE by ID
    const id = req.params.productId
